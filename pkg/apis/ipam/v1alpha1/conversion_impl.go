...
func convert_v1alpha1_IPPrefixClaim_To_ipam(in *IPPrefixClaim, out *ipam.IPPrefixClaim) error {
	...
	out.Spec = ipam.IPPrefixClaimSpec{
		...
		CreateChildPrefix:   in.Spec.CreateChildPrefix,
...
func convert_v1alpha1_ASNPoolClass_To_ipam(in *ASNPoolClass, out *ipam.ASNPoolClass) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = ipam.ASNPoolClassSpec{
		Visibility: in.Spec.Visibility,
	}
	return nil
}
func convert_ipam_ASNPoolClass_To_v1alpha1(in *ipam.ASNPoolClass, out *ASNPoolClass) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = ASNPoolClassSpec{
		Visibility: in.Spec.Visibility,
	}
	return nil
}

func convert_v1alpha1_ASNPoolClassList_To_ipam(in *ASNPoolClassList, out *ipam.ASNPoolClassList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ipam.ASNPoolClass, len(in.Items))
		for i := range in.Items {
			if err := convert_v1alpha1_ASNPoolClass_To_ipam(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
...
func convert_ipam_ASNPoolClassList_To_v1alpha1(in *ipam.ASNPoolClassList, out *ASNPoolClassList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ASNPoolClass, len(in.Items))
		for i := range in.Items {
			if err := convert_ipam_ASNPoolClass_To_v1alpha1(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
...
func convert_v1alpha1_ASNPool_To_ipam(in *ASNPool, out *ipam.ASNPool) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec.ClassRef = ipam.LocalRef{Name: in.Spec.ClassRef.Name}
	if in.Spec.Ranges != nil {
		out.Spec.Ranges = make([]ipam.ASNRange, len(in.Spec.Ranges))
		for i, r := range in.Spec.Ranges {
			out.Spec.Ranges[i] = ipam.ASNRange{Start: r.Start, End: r.End}
		}
	}
	out.Status = ipam.ASNPoolStatus{
		Capacity:   ipam.ASNCapacity(in.Status.Capacity),
		Conditions: toIpamConditions(in.Status.Conditions),
	}
	return nil
}
func convert_ipam_ASNPool_To_v1alpha1(in *ipam.ASNPool, out *ASNPool) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec.ClassRef = LocalRef{Name: in.Spec.ClassRef.Name}
	if in.Spec.Ranges != nil {
		out.Spec.Ranges = make([]ASNRange, len(in.Spec.Ranges))
		for i, r := range in.Spec.Ranges {
			out.Spec.Ranges[i] = ASNRange{Start: r.Start, End: r.End}
		}
	}
	out.Status = ASNPoolStatus{
		Capacity:   ASNCapacity(in.Status.Capacity),
		Conditions: toIpamConditions(in.Status.Conditions),
	}
	return nil
}

func convert_v1alpha1_ASNPoolList_To_ipam(in *ASNPoolList, out *ipam.ASNPoolList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ipam.ASNPool, len(in.Items))
		for i := range in.Items {
			if err := convert_v1alpha1_ASNPool_To_ipam(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
...
func convert_ipam_ASNPoolList_To_v1alpha1(in *ipam.ASNPoolList, out *ASNPoolList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ASNPool, len(in.Items))
		for i := range in.Items {
			if err := convert_ipam_ASNPool_To_v1alpha1(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
...
func convert_v1alpha1_ASNClaim_To_ipam(in *ASNClaim, out *ipam.ASNClaim) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = ipam.ASNClaimSpec{
		ClassRef: toIpamLocalRef(in.Spec.ClassRef),
		PoolRef:  toIpamLocalRef(in.Spec.PoolRef),
		OwnerRef: toIpamObjectRef(in.Spec.OwnerRef),
	}
	out.Status = ipam.ASNClaimStatus{
		Phase:        ipam.ClaimPhase(in.Status.Phase),
		ASN:          in.Status.ASN,
		BoundPoolRef: toIpamLocalRef(in.Status.BoundPoolRef),
		Conditions:   toIpamConditions(in.Status.Conditions),
	}
	return nil
}
func convert_ipam_ASNClaim_To_v1alpha1(in *ipam.ASNClaim, out *ASNClaim) error {
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = ASNClaimSpec{
		ClassRef: toV1LocalRef(in.Spec.ClassRef),
		PoolRef:  toV1LocalRef(in.Spec.PoolRef),
		OwnerRef: toV1ObjectRef(in.Spec.OwnerRef),
	}
	out.Status = ASNClaimStatus{
		Phase:        ClaimPhase(in.Status.Phase),
		ASN:          in.Status.ASN,
		BoundPoolRef: toV1LocalRef(in.Status.BoundPoolRef),
		Conditions:   toIpamConditions(in.Status.Conditions),
	}
	return nil
}

func convert_v1alpha1_ASNClaimList_To_ipam(in *ASNClaimList, out *ipam.ASNClaimList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ipam.ASNClaim, len(in.Items))
		for i := range in.Items {
			if err := convert_v1alpha1_ASNClaim_To_ipam(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
...
func convert_ipam_ASNClaimList_To_v1alpha1(in *ipam.ASNClaimList, out *ASNClaimList) error {
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		out.Items = make([]ASNClaim, len(in.Items))
		for i := range in.Items {
			if err := convert_ipam_ASNClaim_To_v1alpha1(&in.Items[i], &out.Items[i]); err != nil {
				return err
			}
		}
	}
